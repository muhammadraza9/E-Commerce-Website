      ...
      <section className="relative px-6 py-32 flex items-center overflow-hidden min-h-[420px]">
        ...
        <div className="relative max-w-7xl mx-auto w-full">
          ...
          <p className="mt-4 text-lg text-gray-200 font-medium drop-shadow-[0_1px_4px_rgba(0,0,0,0.8)] max-w-2xl">
            The story behind Style Avenue — Pakistan's trusted destination for
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-100 leading-8">
              ...
              gentlemen who care about how they look and carry themselves every
              day. We curate a wide range of clothing — from sharp formal suits
              to refined casual wear — blending the latest trends with timeless
              style.
            </p>

            <p className="text-gray-100 leading-8 mt-5">
              Every product is chosen with quality, fit, and style in mind.
              Whether you're dressing for the boardroom or a weekend out, we
              bring you menswear that commands respect without compromising on
              comfort.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="border border-slate-600 bg-black/40 backdrop-blur-sm rounded-2xl p-8 text-center">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                Every item is hand-picked and quality-checked before it reaches
                you.
              </p>
            </div>
        ...
        <div className="rounded-2xl overflow-hidden shadow-2xl relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
            <h3 className="text-white text-2xl font-bold drop-shadow-lg">
              Dress Sharp.{" "}
              <span className="text-[#D4AF37]">Look Confident.</span>
            </h3>

            <p className="text-gray-200 mt-2 text-sm max-w-md drop-shadow">
              Explore our latest men's collections and find your signature
              style.
            </p>
          </div>
        </div>
